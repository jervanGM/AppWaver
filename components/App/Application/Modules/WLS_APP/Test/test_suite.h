 ...
 */
extern void protocol_drv_test_suite();
 ...
 * This function runs all the test defined for this test suite.
 */
extern void network_sm_test_suite();
 ...
 * This function runs all the test defined for this test suite.
 */
extern void network_app_test_suite();
 ...
 * This function runs all the test defined for this test suite.
 */
extern void wireless_task_test_suite();
...
static inline void run_test_suites()
{
    ...
    protocol_drv_test_suite();
    network_sm_test_suite();
    network_app_test_suite();
    wireless_task_test_suite();
}
