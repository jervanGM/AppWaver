 ...
 * that the initialization result is BUS_TASK_OK.
 */
void test_bus_sm_init_valid_pointers(); /**< \test */
 ...
 * that the initialization result is BUS_TASK_SM_INIT_FAIL.
 */
void test_bus_sm_init_null_pointers(); /**< \test */
 ...
 * and verifies that the state is correctly set to BUS_OPERATIONAL.
 */
void test_bus_sm_init_to_operational_transition(); /**< \test */
 ...
 * and verifies that the state is correctly set to BUS_BREAKDOWN.
 */
void test_bus_sm_init_to_breakdown_transition(); /**< \test */
 ...
 * and verifies that the state remains in BUS_INIT.
 */
void test_bus_sm_init_unknown_state_transition(); /**< \test */
