...
void test_short_and_long_press_combination() {
    ...
    btn_app_init();
    // Corta, larga, corta
    cmd = btn_app_process_cmd(pulse_short);
    TEST_ASSERT_EQUAL(cmd , BTN_CMD_MODE1);

    cmd = btn_app_process_cmd(pulse_long);
    TEST_ASSERT_EQUAL(cmd , BTN_CMD_NORMAL);
...
void btn_app_test_suite()
{
    #ifndef FAKE_FUNC
    RUN_TEST(test_btn_app_check_mayor_faults);
    RUN_TEST(test_btn_app_check_minor_faults);
    RUN_TEST(test_btn_app_check_no_faults);
    RUN_TEST(test_btn_app_check_lower_minor_fault_boundary);
    RUN_TEST(test_btn_app_check_upper_minor_fault_boundary);
    RUN_TEST(test_btn_app_check_lower_major_fault_boundary);
    RUN_TEST(test_btn_app_check_upper_major_fault_boundary);
    RUN_TEST(test_btn_app_process_short_press_cmd);
    RUN_TEST(test_btn_app_process_long_press_cmd);
    RUN_TEST(test_btn_app_process_power_off_cmd);
    RUN_TEST(test_btn_app_process_no_pulse_cmd);
    RUN_TEST(test_btn_app_process_error_cmd);
    RUN_TEST(test_btn_app_process_unknown_cmd);
