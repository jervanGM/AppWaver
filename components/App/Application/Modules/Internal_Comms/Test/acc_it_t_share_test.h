 ...
 * It sets a sample task information, sends it using the set_task_acc_it_info function,
 * and then reads the information back using the acc_it_controller_read function.
 * Finally, it asserts that the sent task information matches the received task information.
 */
void test_set_and_read_task_acc_it_info(void); /**< \test */
 ...
 * It sets a sample plant buffer and buffer time, sends them using the acc_it_controller_send function,
 * and then reads the data back using the acc_it_controller_read function.
 * Finally, it asserts that the sent plant buffer and buffer time match the received data.
 */
void test_send_and_read_acc_it_controller_data(void); /**< \test */
 ...
 * It sets a sample task status, sends it using the set_task_acc_it_status function,
 * and then reads the status back using the acc_it_controller_read function.
 * Finally, it asserts that the sent task status matches the received task status.
 */
void test_set_and_read_task_acc_it_status(void); /**< \test */
