...
{  
    ...
    create_task(task_control,"Control Task",16384,CONTROL_T_PERIOD,CONTROL_T_PRIOR,CONTROL_T_HANDLER);
    ...
    create_task(task_ext_memory,"External Memory Task",8192,EXT_MEM_T_PERIOD,EXT_MEM_T_PRIOR,EXT_MEM_T_HANDLER);
